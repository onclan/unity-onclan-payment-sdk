...
@interface OCSDKFMResultSet : NSObject {
    OCSDKFMDatabase          *_parentDB;
    OCSDKFMStatement         *_statement;
...
@property (atomic, retain) OCSDKFMStatement *statement;
...
+ (instancetype)resultSetWithStatement:(OCSDKFMStatement *)statement usingParentDatabase:(OCSDKFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(OCSDKFMDatabase *)newDb;
