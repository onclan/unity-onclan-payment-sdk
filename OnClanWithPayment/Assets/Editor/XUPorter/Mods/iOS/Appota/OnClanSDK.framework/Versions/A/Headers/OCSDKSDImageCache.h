...
typedef NS_ENUM(NSInteger, OCSDKSDImageCacheType) {
    /**
     * The image wasn't available the SDWebImage caches, but was downloaded from the web.
     */
    OCSDKSDImageCacheTypeNone,
    /**
     * The image was obtained from the disk cache.
     */
    OCSDKSDImageCacheTypeDisk,
    /**
     * The image was obtained from the memory cache.
     */
    OCSDKSDImageCacheTypeMemory
};

typedef void(^OCSDKSDWebImageQueryCompletedBlock)(UIImage *image, OCSDKSDImageCacheType cacheType);

/**
 * SDImageCache maintains a memory cache and an optional disk cache. Disk cache write operations are performed
 * asynchronous so it doesn’t add unnecessary latency to the UI.
 */
@interface OCSDKSDImageCache : NSObject
 ...
 */
+ (OCSDKSDImageCache *)sharedImageCache;
 ...
 */
- (NSOperation *)queryDiskCacheForKey:(NSString *)key done:(OCSDKSDWebImageQueryCompletedBlock)doneBlock;
