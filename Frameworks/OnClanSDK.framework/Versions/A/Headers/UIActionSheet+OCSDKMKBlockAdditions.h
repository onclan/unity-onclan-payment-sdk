//
//  UIActionSheet+OCSDKMKBlockAdditions.h
...
@interface UIActionSheet (OCSDKMKBlockAdditions) <UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
