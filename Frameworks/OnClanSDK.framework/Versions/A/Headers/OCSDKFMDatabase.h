...
#import "sqlite3.h"
#import "OCSDKFMResultSet.h"
#import "FMDatabasePool.h"


#if ! __has_feature(objc_arc)
    #define OCSDKFMDBAutorelease(__v) ([__v autorelease]);
    #define OCSDKFMDBReturnAutoreleased OCSDKFMDBAutorelease

    #define OCSDKFMDBRetain(__v) ([__v retain]);
    #define OCSDKFMDBReturnRetained OCSDKFMDBRetain

    #define OCSDKFMDBRelease(__v) ([__v release]);

    #define OCSDKFMDBDispatchQueueRelease(__v) (dispatch_release(__v));
#else
    // -fobjc-arc
    #define OCSDKFMDBAutorelease(__v)
    #define OCSDKFMDBReturnAutoreleased(__v) (__v)

    #define OCSDKFMDBRetain(__v)
    #define OCSDKFMDBReturnRetained(__v) (__v)

    #define OCSDKFMDBRelease(__v)

// If OS_OBJECT_USE_OBJC=1, then the dispatch objects will be treated like ObjC objects
// and will participate in ARC.
// See the section on "Dispatch Queues and Automatic Reference Counting" in "Grand Central Dispatch (GCD) Reference" for details. 
    #if OS_OBJECT_USE_OBJC
        #define OCSDKFMDBDispatchQueueRelease(__v)
    #else
        #define OCSDKFMDBDispatchQueueRelease(__v) (dispatch_release(__v));
    #endif
#endif
...
@interface OCSDKFMDatabase : NSObject  {
...
- (OCSDKFMResultSet *)executeQuery:(NSString*)sql, ...;
...
- (OCSDKFMResultSet *)executeQueryWithFormat:(NSString*)format, ... NS_FORMAT_FUNCTION(1,2);
...
- (OCSDKFMResultSet *)executeQuery:(NSString *)sql withArgumentsInArray:(NSArray *)arguments;
...
- (OCSDKFMResultSet *)executeQuery:(NSString *)sql withParameterDictionary:(NSDictionary *)arguments;


// Documentation forthcoming.
- (OCSDKFMResultSet *)executeQuery:(NSString*)sql withVAList: (va_list)args;
...
@interface OCSDKFMStatement : NSObject {
