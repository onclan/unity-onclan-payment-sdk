...
@interface AppotaPaymentSDKDialog : UIView <UIWebViewDelegate, UIScrollViewDelegate> {
 ...
 */
- (void)dialogDidComplete:(AppotaPaymentSDKDialog *)dialog;
 ...
 */
- (void)dialogDidNotComplete:(AppotaPaymentSDKDialog *)dialog;

/**
 * Called when dialog failed to load due to an error.
 */
- (void)dialog:(AppotaPaymentSDKDialog*)dialog didFailWithError:(NSError *)error;
 ...
 */
- (BOOL)dialog:(AppotaPaymentSDKDialog*)dialog shouldOpenURLInExternalBrowser:(NSURL *)url;
